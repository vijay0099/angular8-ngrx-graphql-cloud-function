...
// DATA
import { children, needs, posts, comments, notifications, notificationUsers, users, usernames } from '../../../../libs/graphql-playground/data-access-data/src';
...
const childrenNeedsCollection = {
    ...
    nested: {
        ...
        nestedCleaningDefinition: ['id', 'description'],
        jointFieldName: 'belongsTo'
    }
};
// DATABASE DEFINITION ================================================================================
...
//# sourceMappingURL=little-dragon-ngo.js.map