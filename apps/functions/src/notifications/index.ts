...
//     const privateUserDataDoc = firestoreInstance
//       .collection('PrivateUserData')
//       .doc(userId);
//     const newEventPromise = privateUserDataDoc
//       .collection(EVENTS)
//       .doc()
//       .set(data);
//     const updateTokensPromise = privateUserDataDoc.update(
//       'messagingTokens',
//       tokens
//     );
//     //Execute them
...
//     console.log(
//       'The process of send a new follow notification for the user ',
//       userId,
//       ' has finished successfully'
//     );
//   } catch (err) {
//     console.error(
//       'Failed sending a follow notification to user',
//       userId,
//       'with error',
//       err
//     );
...
//     const eventAlreadyExist = await userEventExist(
//       commentAuthorId,
//       kind,
//       postId
//     );
