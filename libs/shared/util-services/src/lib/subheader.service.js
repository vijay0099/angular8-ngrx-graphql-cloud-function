...
let SubheaderService = class SubheaderService {
     ...
     */
    constructor(router, pageConfigService, menuConfigService) {
        this.router = router;
...
SubheaderService = tslib_1.__decorate([
    Injectable(),
    tslib_1.__metadata("design:paramtypes", [typeof (_a = typeof Router !== "undefined" && Router) === "function" ? _a : Object, PageConfigService,
        MenuConfigService])
], SubheaderService);
