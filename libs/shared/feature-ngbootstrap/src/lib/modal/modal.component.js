...
NgbdModalContentComponent = tslib_1.__decorate([
    Component({
        selector: 'monorepo-ngbd-modal-content',
        template: `
    <div class="modal-header">
      <h4 class="modal-title">Hi there!</h4>
      <button type="button" class="close" aria-label="Close" (click)="activeModal.dismiss('Cross click')">
  ...
  `
    ...
    tslib_1.__metadata("design:paramtypes", [typeof (_a = typeof NgbActiveModal !== "undefined" && NgbActiveModal) === "function" ? _a : Object])
], NgbdModalContentComponent);
export { NgbdModalContentComponent };
...
ModalComponent = tslib_1.__decorate([
  ...
  `]
    ...
    tslib_1.__metadata("design:paramtypes", [typeof (_b = typeof NgbModal !== "undefined" && NgbModal) === "function" ? _b : Object])
], ModalComponent);
