...
let CarouselComponent = class CarouselComponent {
    ...
    ngOnInit() {
        ...
        this._http.get('https://picsum.photos/list')
            .pipe(map((images) => this._randomImageUrls(images)))
            .subscribe(images => this.images = images);
        this._http.get('https://picsum.photos/list')
            .pipe(map((images) => this._randomImageUrls(images)))
...
CarouselComponent = tslib_1.__decorate([
    Component({
        selector: 'monorepo-carousel',
        templateUrl: './carousel.component.html',
        changeDetection: ChangeDetectionStrategy.OnPush,
        providers: [NgbCarouselConfig] // add NgbCarouselConfig to the component providers
    }),
    tslib_1.__metadata("design:paramtypes", [typeof (_a = typeof HttpClient !== "undefined" && HttpClient) === "function" ? _a : Object, typeof (_b = typeof NgbCarouselConfig !== "undefined" && NgbCarouselConfig) === "function" ? _b : Object])
], CarouselComponent);
