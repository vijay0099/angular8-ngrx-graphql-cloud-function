...
// SERVICES
import { WikipediaService } from '@monorepo/shared/util-services';
...
let TypeheadComponent = class TypeheadComponent {
    constructor(_service, config) {
        ...
        this.search6 = (text$) => text$.pipe(debounceTime(200), distinctUntilChanged(), map(term => term.length < 2
            ? []
            : states
        ...
        this.search5 = (text$) => text$.pipe(debounceTime(200), map(term => term === ''
            ? []
            : statesWithFlags
        ...
        this.search4 = (text$) => text$.pipe(debounceTime(300), distinctUntilChanged(), tap(() => (this.searching = true)), switchMap(term => this._service.search(term).pipe(tap(() => (this.searchFailed = false)), catchError(() => {
            this.searchFailed = true;
            return of([]);
        }))), tap(() => (this.searching = false)));
        this.search3 = (text$) => text$.pipe(debounceTime(200), distinctUntilChanged(), map(term => term === ''
            ? []
            : states
...
tslib_1.__decorate([
    ...
    tslib_1.__metadata("design:type", typeof (_a = typeof NgbTypeahead !== "undefined" && NgbTypeahead) === "function" ? _a : Object)
], TypeheadComponent.prototype, "instance", void 0);
TypeheadComponent = tslib_1.__decorate([
    Component({
        selector: 'monorepo-typehead',
    ...
    tslib_1.__metadata("design:paramtypes", [WikipediaService, typeof (_b = typeof NgbTypeaheadConfig !== "undefined" && NgbTypeaheadConfig) === "function" ? _b : Object])
], TypeheadComponent);
export { TypeheadComponent };
