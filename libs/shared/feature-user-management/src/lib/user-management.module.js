...
// SERVICES
import { LayoutUtilsService, InterceptService, TypesUtilsService, HttpUtilsService } from '@monorepo/shared/util-services';
// CRUD
...
// CORE
import { usersReducer, UserEffects } from '@monorepo/shared/data-access-core';
const routes = [
    {
        path: '',
