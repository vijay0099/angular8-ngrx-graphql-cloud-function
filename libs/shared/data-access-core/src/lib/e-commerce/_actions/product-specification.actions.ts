...
export class ProductSpecificationOnServerCreated implements Action {
  ...
  constructor(
    public payload: { productSpecification: ProductSpecificationModel }
  ) {}
}
...
export class ProductSpecificationsPageLoaded implements Action {
  readonly type =
    ProductSpecificationActionTypes.ProductSpecificationsPageLoaded;
  constructor(
    public payload: {
...
export class ProductSpecificationsPageCancelled implements Action {
  readonly type =
    ProductSpecificationActionTypes.ProductSpecificationsPageCancelled;
}

export class ProductSpecificationsPageToggleLoading implements Action {
  readonly type =
    ProductSpecificationActionTypes.ProductSpecificationsPageToggleLoading;
  constructor(public payload: { isLoading: boolean }) {}
}

export type ProductSpecificationActions =
