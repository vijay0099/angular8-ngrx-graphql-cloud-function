...
// CORE
// import { AppState } from '@monorepo/shared/data-access-core';
// SERVICES
import { LayoutUtilsService, MessageType } from '@monorepo/shared/util-services';
// MODELS
import { QueryParamsModel, CustomerModel } from '@monorepo/shared/data-access-models';
// CORE
import { CustomersDataSource, CustomersPageRequested, OneCustomerDeleted, ManyCustomersDeleted, CustomersStatusUpdated } from '@monorepo/shared/data-access-core';
// COMPONENTS
...
let CustomersListComponent = class CustomersListComponent {
     ...
     */
    constructor(dialog, snackBar, layoutUtilsService, translate, store) {
        this.dialog = dialog;
     ...
     */
    deleteCustomer(_item) {
        const _title = this.translate.instant('ECOMMERCE.CUSTOMERS.DELETE_CUSTOMER_SIMPLE.TITLE');
        const _description = this.translate.instant('ECOMMERCE.CUSTOMERS.DELETE_CUSTOMER_SIMPLE.DESCRIPTION');
        const _waitDesciption = this.translate.instant('ECOMMERCE.CUSTOMERS.DELETE_CUSTOMER_SIMPLE.WAIT_DESCRIPTION');
     ...
     */
    deleteCustomers() {
        const _title = this.translate.instant('ECOMMERCE.CUSTOMERS.DELETE_CUSTOMER_MULTY.TITLE');
        const _description = this.translate.instant('ECOMMERCE.CUSTOMERS.DELETE_CUSTOMER_MULTY.DESCRIPTION');
        const _waitDesciption = this.translate.instant('ECOMMERCE.CUSTOMERS.DELETE_CUSTOMER_MULTY.WAIT_DESCRIPTION');
     ...
     * @param status: number
     */
    getItemCssClassByType(status = 0) {
        switch (status) {
            case 0:
                return 'accent';
            case 1:
...
CustomersListComponent = tslib_1.__decorate([
    Component({
        // tslint:disable-next-line:component-selector
        selector: 'monorepo-customers-list',
        templateUrl: './customers-list.component.html',
        changeDetection: ChangeDetectionStrategy.OnPush
    }),
    tslib_1.__metadata("design:paramtypes", [typeof (_d = typeof MatDialog !== "undefined" && MatDialog) === "function" ? _d : Object, typeof (_e = typeof MatSnackBar !== "undefined" && MatSnackBar) === "function" ? _e : Object, LayoutUtilsService, typeof (_f = typeof TranslateService !== "undefined" && TranslateService) === "function" ? _f : Object, typeof (_g = typeof Store !== "undefined" && Store) === "function" ? _g : Object])
