...
DynamicDataSource = tslib_1.__decorate([
    Injectable(),
    tslib_1.__metadata("design:paramtypes", [typeof (_a = typeof FlatTreeControl !== "undefined" && FlatTreeControl) === "function" ? _a : Object, DynamicDatabase, typeof (_b = typeof ChangeDetectorRef !== "undefined" && ChangeDetectorRef) === "function" ? _b : Object])
], DynamicDataSource);
...
let TreeComponent = class TreeComponent {
    constructor(database, database2, database3, database4, cdr) {
        ...
        this.newItemName3 = '';
        /** The selection for checklist */
        this.checklistSelection3 = new SelectionModel(true /* multiple */);
        ...
        this._getChildren2 = (node) => observableOf(node.children);
        ...
        this.treeControl2 = new FlatTreeControl(this._getLevel2, this._isExpandable2);
        ...
        this.treeControl3 = new FlatTreeControl(this.getLevel3, this.isExpandable3);
        ...
        this.treeControl4 = new FlatTreeControl(this.getLevel4, this.isExpandable4);
...
TreeComponent = tslib_1.__decorate([
    ...
    tslib_1.__metadata("design:paramtypes", [DynamicDatabase,
        FileDatabase,
        ChecklistDatabase,
        LoadmoreDatabase, typeof (_c = typeof ChangeDetectorRef !== "undefined" && ChangeDetectorRef) === "function" ? _c : Object])
], TreeComponent);
