...
Modal3Component = tslib_1.__decorate([
    Component({
        selector: 'monorepo-modal3',
        template: `
		<div class="col-xl-12">
			<div class="col-xl-12">
...
export { Modal3Component };
let Modal2Component = class Modal2Component {
    constructor(data) {
        this.data = data;
    }
};
Modal2Component = tslib_1.__decorate([
    Component({
        selector: 'monorepo-modal2',
        template: `
		<div class="col-xl-12">
			<div class="col-xl-12">
...
let DialogComponent = class DialogComponent {
    constructor(dialog) {
        this.dialog = dialog;
        this.animal2 = '';
        this.animalSubject = new BehaviorSubject('');
    }
    ngOnInit() {
...
DialogComponent = tslib_1.__decorate([
    ...
    tslib_1.__metadata("design:paramtypes", [typeof (_b = typeof MatDialog !== "undefined" && MatDialog) === "function" ? _b : Object])
], DialogComponent);
