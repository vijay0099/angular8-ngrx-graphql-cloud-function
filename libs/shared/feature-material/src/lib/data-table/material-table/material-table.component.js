...
let MaterialTableComponent = class MaterialTableComponent {
    constructor(http) {
        ...
        this.dataSource4 = new MatTableDataSource(ELEMENT_DATA);
        this.dataSource5 = new MatTableDataSource(ELEMENT_DATA);
        this.dataSource6 = [];
...
tslib_1.__decorate([
    ViewChild('matPaginator2', { static: true }),
...
tslib_1.__decorate([
    ViewChild('matPaginator6', { static: true }),
...
tslib_1.__decorate([
    ViewChild('matPaginator7', { static: true }),
    tslib_1.__metadata("design:type", typeof (_c = typeof MatPaginator !== "undefined" && MatPaginator) === "function" ? _c : Object)
], MaterialTableComponent.prototype, "paginator7", void 0);
tslib_1.__decorate([
    ViewChild('sort3', { static: true }),
    tslib_1.__metadata("design:type", typeof (_d = typeof MatSort !== "undefined" && MatSort) === "function" ? _d : Object)
], MaterialTableComponent.prototype, "sort3", void 0);
tslib_1.__decorate([
    ViewChild('sort6', { static: true }),
    tslib_1.__metadata("design:type", typeof (_e = typeof MatSort !== "undefined" && MatSort) === "function" ? _e : Object)
], MaterialTableComponent.prototype, "sort6", void 0);
tslib_1.__decorate([
    ViewChild('sort7', { static: true }),
    tslib_1.__metadata("design:type", typeof (_f = typeof MatSort !== "undefined" && MatSort) === "function" ? _f : Object)
], MaterialTableComponent.prototype, "sort7", void 0);
MaterialTableComponent = tslib_1.__decorate([
    Component({
        selector: 'monorepo-material-table',
...
.example-loading-shade {
  ...
  .mat-column-created {
    ...
    tslib_1.__metadata("design:paramtypes", [typeof (_g = typeof HttpClient !== "undefined" && HttpClient) === "function" ? _g : Object])
