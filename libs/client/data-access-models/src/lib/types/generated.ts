...
export type CreateUserMutation = (
  ...
  & { createUser: (
    { __typename?: 'User' }
    & Pick<User, 'id' | 'username' | 'fullName' | 'email' | 'phoneNumber' | 'role' | 'providerId' | 'photoUrl' | 'isNewUser'>
  ) }
);
...
export type ValidateUserQueryVariables = {
  query: UserValidateInput;
};
...
export type ValidateUserQuery = (
  ...
  & { validateUser: (
    { __typename?: 'UserValidateOutput' }
    & Pick<UserValidateOutput, 'status'>
  ) }
);
