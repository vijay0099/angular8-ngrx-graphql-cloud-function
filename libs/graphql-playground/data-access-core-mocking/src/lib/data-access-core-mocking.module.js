...
let DataAccessCoreMockingModule = class DataAccessCoreMockingModule {
    constructor() {
        console.log(colors.brightMagenta('\nMOCKING_DATA_MODE :: Using mocking data.\n'));
    }
};
DataAccessCoreMockingModule = tslib_1.__decorate([
    Module({
        imports: [
            // MODULES
            ChildModule,
...
export { DataAccessCoreMockingModule };
//# sourceMappingURL=data-access-core-mocking.module.js.map